...
import (
	"context"
	placesV1 "github.com/KubaiDoLove/conductor/internal/app/resources/places/v1"
	...
	"github.com/KubaiDoLove/conductor/internal/app/resources"
...
func NewHTTPServer(ctx context.Context, opts *Config, ds drivers.DataStore, version string) *HTTPServer {
	srv := &HTTPServer{
...
func (srv *HTTPServer) setupRouter() chi.Router {
	...
	r.Mount("/api/v1/places", placesV1.NewPlacesResource(srv.ds.Places()).Routes())
