...
type Config struct {
	...
	DSDB   string `short:"d" long:"ds-db" env:"DATASTORE_DB" description:"DataStore database name (format: inventory)" required:"false" default:"conductor"`
	...
	BasePath   string `long:"base-path" env:"BASE_PATH" description:"base path of the host" required:"false" default:"myBasePath"`
